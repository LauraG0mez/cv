...
\header{Laura }{Gomez}{System Engineer in Mechatronics and Biomechanics}         % Your name
%\lastupdated
...
\entry
  ...
  {\jobtitle{Systems engineer, Mechatronics Engineer, Industrial Engineer}\\
...
\entry
  ...
  {Aeronautics}
  {\jobtitle{Technical Project Manager on Mechatronics Systems }\\
...
\entry
 ...
 {\jobtitle{Technical project manager on Cobotic Systems}\\
...
%\entry
%{2010 -- 2013 }
% {Valeo (Apprenticeship)}
% {Automotive}
% {\jobtitle{Engineer assistant}\\
% Comparison of fluid mechanics software

% Post-processing of Flotherm results for model reduction
% }
%------------------------------------------------
